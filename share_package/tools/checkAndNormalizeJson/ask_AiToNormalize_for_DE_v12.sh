...
if [[ "${_prefix}" != "DE" ]]; then
    echo "エラー: JSONファイル名は 'DE_' で始まる必要があります"
...
#TemplateFile=${this_script_parent}/../../templates/DE_v11_Author20XX_by_Someone_YYYYmmddHHMMSS.json
...
function copyTemplate(){
    ...
    # テンプレートファイルを指定
    _template_json_file=${TemplateFile}
