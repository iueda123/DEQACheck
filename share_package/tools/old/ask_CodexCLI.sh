...
#AuthorYearArray+=("Bedford2025" "Berthet2025" "Bethlehem2020" "Bethlehem2021")
#AuthorYearArray+=("Bhome2024" "CardenasDeLaParra2019" "Chan2025A" "Chan2025B" "Chien2022")
#AuthorYearArray+=("Cirstian2024" "Coupe2022" "DeMeo2019" "DiBiase2022" "Ebadi2024")
#AuthorYearArray+=("Echave2024" "Elad2021")
...
#AuthorYearArray+=("Gordaliza2024" "Haas2024" "Han2023" "Han2024A")
#AuthorYearArray+=("Han2024B" "Haukvik2025" "Holz2023" "Hua2025" "Huang2024")
#AuthorYearArray+=("Huo2024")

#AuthorYearArray+=("Ilioska2024" "Italinna2023" "Jalbrzikowski2019" "Janahi2022")
#AuthorYearArray+=("Janssen2021" "Janssen2024" "Ji2023" "Jia2024" "Jia2025")
#AuthorYearArray+=("Jiang2024" "Jing2023" "Joo2024")

#AuthorYearArray+=("Kasper2024" "Kia2022")
...
#AuthorYearArray+=("Martin2025" "Meijer2024" "Mendes2024")
#AuthorYearArray+=("Narai2024" "OliveiraSaraiva2023" "Parkes2021" "Pinaya2019" "Pinaya2021")
#AuthorYearArray+=("RehakBuckova2025" "Remiszewski2022" "Romascano2024" "Rutherford2022" "Rutherford2023")
#AuthorYearArray+=("Sampaio2025" "Savage2024" "Segal2023" "Segal2025" "Shan2022")
#AuthorYearArray+=("Shao2024" "Sun2023" "Sun2025" "Tabbal2025")
#AuthorYearArray+=("Thukral2024")
#AuthorYearArray+=("Tong2024" "Verdi2023" "Verdi2024" "Vieira2025" "VillalonReina2024")
#AuthorYearArray+=("Wang2023" "Wen2025" "Wolfers2018")
#AuthorYearArray+=("Wolfers2020" "Wolfers2021")
...
for AuthorYear in ${AuthorYearArray[@]}; do
  ...
  if [[ ! -d ./DECheck/json ]]; then
      mkdir -p ./DECheck/json
  fi

  
  # Ask AI agent if the result json was not found.
  _ai_agent=codex
  _folder="./DECheck/json/"
  _trgt="DE_${AuthorYear}_by_${_ai_agent}_*.json"
  if find ${_folder} -maxdepth 1 -type f -iname ${_trgt} | grep -q .; then
      ...
      # Make a flag file  
      echo "The json file is not created yet." > ../DE_${AuthorYear}_by_${_ai_agent}_is_not_yet.txt   
  
      # Ask AI Agent
      codex exec --full-auto --skip-git-repo-check -C . "DE_Guide_v9.md に従って作業をしてください。"
  
      
      # Check Result
      if find ${_folder} -maxdepth 1 -type f -iname ${_trgt} | grep -q .; then
          echo "The JSON was created."
          rm ../DE_${AuthorYear}_by_${_ai_agent}_is_not_yet.txt 
      fi
