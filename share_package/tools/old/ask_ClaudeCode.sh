...
#AuthorYearArray+=("Wang2023" "Wen2025" "Wolfers2018" "Wolfers2020")
...
for AuthorYear in ${AuthorYearArray[@]}; do
  ...
  if find ${_folder} -maxdepth 1 -type f -iname ${_trgt} | grep -q .; then
      ...
      # Ask AI Agent
      claude -p "DE_Guide_v9.md に従って作業をしてください。" \
