...
for AuthorYear in ${AuthorYearArray[@]}; do
  ...
  if find ${_folder} -maxdepth 1 -type f -iname ${_trgt} | grep -q .; then
      ...
      # Ask AI Agent
      #gemini -p "QA_Guide_v6.md に従って作業をしてください。" --approval-mode auto_edit --allowed-tools remove_file run_shell_command
      #gemini -p "QA_Guide_v6.md に従って作業をしてください。" --allowed-tools remove_file run_shell_command
      gemini -p "QA_Guide_v6.md に従って作業をしてください。" --approval-mode auto_edit
      #gemini -p "QA_Guide_v6.md に従って作業をしてください。"
