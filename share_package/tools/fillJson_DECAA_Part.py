...
"""
Fill one clinical_application_and_analysis_part field in Human JSONs from sibling codex JSONs.
...
Select field with required option --item:
  1: caa1_clinical_dataset
  2: caa2_diseases_studied
  3: caa3_clinical_groups_n
  4: caa4_clinical_groups_age
  5: caa5_clinical_groups_sex
  6: caa6_deviation_metric
  7: caa7_association_analysis
  8: caa8_key_findings_brief
  9: caa9_key_findings_detailed
  10: caa10_key_limitations
  11: caa11_application_notes

Usage:
  From repo root:
    python3 tools/fillJson_DECAA_Part.py --item 1 --dry-run
    python3 tools/fillJson_DECAA_Part.py --item 6
"""
...
KEY_ROOT = "clinical_application_and_analysis_part"
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    desc = (
        "Human JSON の clinical_application_and_analysis_part の指定項目を、\n"
