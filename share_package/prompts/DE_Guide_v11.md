...
- ファイル名は `<DE version>_by_<Agent Name>_<AuthorYear>_<Processing Date>.json`
    - Claude Code の場合: `DE_v11_Bethlehem2022_by_claude_202509191115.json`
    - Gemini CLI の場合: `DE_v11_Bethlehem2022_by_gemini_202509191115.json`
    - Codex-CLI の場合: `DE_v11_Bethlehem2022_by_codex_202509191115.json`
    - ファイル名はASCII、空白なし。
- JSONフォーマット
