...
# ask-copilot-to-de-from-Geng2025-using-claude-sonnet-4.6.sh
#
# Geng2025 の材料前処理（アンカー付与）と情報抽出（copilot / claude-sonnet-4.6）を
# 1ステップで実行するスクリプト。
#
# 使用方法:
#   ./ask-copilot-to-de-from-Geng2025-using-claude-sonnet-4.6.sh           # ドライラン（デフォルト）
#   ./ask-copilot-to-de-from-Geng2025-using-claude-sonnet-4.6.sh --run     # 実行モード
