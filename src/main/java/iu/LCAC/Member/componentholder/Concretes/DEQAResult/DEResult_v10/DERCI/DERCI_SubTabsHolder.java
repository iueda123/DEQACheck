...
import iu.LCAC.Member.componentholder.Concretes.DEQAResult.Common.DEQAResultPane.One_ADCSL_Style_Pane;
import iu.LCAC.Member.componentholder.Concretes.DEQAResult.Common.DEQAResultPane.One_ASL_Style_Pane;
...
import iu.LCAC.Member.componentholder.Concretes.DEQAResult.Common.ConfirmBeforeSwitchSelectionModel;
import iu.LCAC.Member.componentholder.Concretes.DEQAResult.Common.SubTabBehaviorUtils;
...
public class DERCI_SubTabsHolder extends AbstCHolderMember implements SubTabsHolderItrfc {
    ...
    static String subSection_1_Name = "rci1_dataset_name";
    static String subSection_2_Name = "rci2_hc_n";
    static String subSection_3_Name = "rci3_hc_age";
    static String subSection_4_Name = "rci4_hc_sex";
    static String subSection_5_Name = "rci5_imaging_modality";
    static String subSection_6_Name = "rci6_analysis_level";
    static String subSection_7_Name = "rci7_preprocessing_pipeline";
    static String subSection_8_Name = "rci8_quality_checking";
    static String subSection_9_Name = "rci9_site_effect_handling";

    static String subSection_1_TabName = "RCI1 Dataset Name";
    static String subSection_2_TabName = "RCI2 HC N";
    static String subSection_3_TabName = "RCI3 HC Age";
    static String subSection_4_TabName = "RCI4 HC Sex";
    static String subSection_5_TabName = "RCI5 Imaging Modality";
    static String subSection_6_TabName = "RCI6 Analysis Level";
    static String subSection_7_TabName = "RCI7 Preprocessing Pipeline";
    static String subSection_8_TabName = "RCI8 Quality Checking";
    static String subSection_9_TabName = "RCI9 Site Effect Handling";
    ...
    ManagerOfSubTabBasePane mngrOfSubTabBasePane_6 = new ManagerOfSubTabBasePane("DE", subSection_6_TabName, sectionName, subSection_6_Name, baseTabPane);
    ManagerOfSubTabBasePane mngrOfSubTabBasePane_7 = new ManagerOfSubTabBasePane("DE", subSection_7_TabName, sectionName, subSection_7_Name, baseTabPane);
    ManagerOfSubTabBasePane mngrOfSubTabBasePane_8 = new ManagerOfSubTabBasePane("DE", subSection_8_TabName, sectionName, subSection_8_Name, baseTabPane);
    ManagerOfSubTabBasePane mngrOfSubTabBasePane_9 = new ManagerOfSubTabBasePane("DE", subSection_9_TabName, sectionName, subSection_9_Name, baseTabPane);

    ArrayList<ManagerOfSubTabBasePane> arrayList_of_ManagerOfSubTabBasePane = new ArrayList<>();
    private final String authorYear;

    public DERCI_SubTabsHolder(String cholder_name, String short_name, String authorYear) {
        ...
        if (jsonFiles != null) {
            for (File jsonFile : jsonFiles) {
                ...
                mngrOfSubTabBasePane_6.addToTheDePaneArray(new One_ASL_Style_Pane(jsonFolderPathString.toString(), jsonFileName, sectionName, subSection_6_Name));
                ...
                mngrOfSubTabBasePane_8.addToTheDePaneArray(new One_ADCSL_Style_Pane(jsonFolderPathString.toString(), jsonFileName, sectionName, subSection_8_Name));
                mngrOfSubTabBasePane_9.addToTheDePaneArray(new One_ADCSL_Style_Pane(jsonFolderPathString.toString(), jsonFileName, sectionName, subSection_9_Name));
            }
        }
