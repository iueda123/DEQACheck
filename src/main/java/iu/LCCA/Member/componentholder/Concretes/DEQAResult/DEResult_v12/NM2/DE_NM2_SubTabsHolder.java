package iu.LCCA.Member.componentholder.Concretes.DEQAResult.DEResult_v12.NM2;
...
public class DE_NM2_SubTabsHolder extends AbstCHolderMember implements SubTabsHolderItrfc {
    ...
    static String subSection_1_Name = "nm2_1_modeling_method";
    static String subSection_2_Name = "nm2_2_response_variable";

    static String subSection_1_TabName = "NM2 Modeling Method";
