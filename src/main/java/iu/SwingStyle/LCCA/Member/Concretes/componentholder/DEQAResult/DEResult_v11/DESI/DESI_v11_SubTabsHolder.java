...
public class DESI_v11_SubTabsHolder extends AbstCHolderMember implements SubTabsHolderItrfc {

    public static final String staticMemberName = "sub_tabs_holder_DE_SI";
    ...
    static String subSection_1_Name = "si_1_study_id";
    static String subSection_2_Name = "si_2_reference_file_names";
    static String subSection_3_Name = "si_3_author_journal_year";
    static String subSection_4_Name = "si_4_title";
    ...
    public DESI_v11_SubTabsHolder(String cholder_name, String short_name, String authorYear) {
