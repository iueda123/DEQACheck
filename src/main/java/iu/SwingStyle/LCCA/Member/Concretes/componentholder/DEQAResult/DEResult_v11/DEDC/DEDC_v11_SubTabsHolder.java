...
public class DEDC_v11_SubTabsHolder extends AbstCHolderMember implements SubTabsHolderItrfc {
    ...
    static String subSection_1_Name = "dc_1_datasets_using_in_this_study";
    static String subSection_2_Name = "dc_2_purpose_of_each_dataset";
    static String subSection_3_Name = "dc_3_number_of_healthy_control_of_each_normative_nodel";
    static String subSection_4_Name = "dc_4_age_info_of_each_normative_nodel";
    static String subSection_5_Name = "dc_5_sex_info_of_each_normative_nodel";
    ...
    public DEDC_v11_SubTabsHolder(String cholder_name, String short_name, String authorYear) {
