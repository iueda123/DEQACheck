 ...
 * <p/>
 * To use this class, construct a new <tt>DnD.PrepForFsPanel.SupportingClasses.FileDrop</tt> by passing
 ...
 *      new DnD.PrepForFsPanel.SupportingClasses.FileDrop( myPanel, new DnD.PrepForFsPanel.SupportingClasses.FileDrop.Listener()
 *      {   public void filesDropped( java.io.File[] files )
 *          {
 *              // handle file drop
 *              ...
 *          }   // end filesDropped
 *      }); // end DnD.PrepForFsPanel.SupportingClasses.FileDrop.Listener
 * </pre></code>
 * <p/>
...
public class FileDrop {
        ...
        if (supportsDnD()) {   // Make a drop listener
            dropListener = new java.awt.dnd.DropTargetListener() {
                public void dragEnter(java.awt.dnd.DropTargetDragEvent evt) {
                    log(out, "DnD.PrepForFsPanel.SupportingClasses.FileDrop: dragEnter event.");
                    ...
                    if (isDragOk(out, evt)) {
                        ...
                        if (c instanceof javax.swing.JComponent) {
                            ...
                            log(out, "DnD.PrepForFsPanel.SupportingClasses.FileDrop: normal border saved.");
                            jc.setBorder(dragBorder);
                            log(out, "DnD.PrepForFsPanel.SupportingClasses.FileDrop: drag border set.");
                        }   // end if: JComponent   

                        // Acknowledge that it's okay to enter
                        //evt.acceptDrag( java.awt.dnd.DnDConstants.ACTION_COPY_OR_MOVE );
                        evt.acceptDrag(java.awt.dnd.DnDConstants.ACTION_COPY);
                        log(out, "DnD.PrepForFsPanel.SupportingClasses.FileDrop: event accepted.");
                    }   // end if: drag ok
                    else {   // Reject the drag event
                        evt.rejectDrag();
                        log(out, "DnD.PrepForFsPanel.SupportingClasses.FileDrop: event rejected.");
                ...
                public void drop(java.awt.dnd.DropTargetDropEvent evt) {
                    log(out, "DnD.PrepForFsPanel.SupportingClasses.FileDrop: drop event.");
                    try {   // Get whatever was dropped
                        ...
                        if (tr.isDataFlavorSupported(DataFlavor.javaFileListFlavor)) {
                            ...
                            log(out, "DnD.PrepForFsPanel.SupportingClasses.FileDrop: file list accepted.");
                            ...
                            log(out, "DnD.PrepForFsPanel.SupportingClasses.FileDrop: drop complete.");
                        }   // end if: file list
                        else // this section will check for a reader flavor.
                        {
                            ...
                            for (int zz = 0; zz < flavors.length; zz++) {
                                if (flavors[zz].isRepresentationClassReader()) {
                                    ...
                                    //evt.acceptDrop ( java.awt.dnd.DnDConstants.ACTION_COPY_OR_MOVE );
                                    evt.acceptDrop(java.awt.dnd.DnDConstants.ACTION_COPY);
                                    log(out, "DnD.PrepForFsPanel.SupportingClasses.FileDrop: reader accepted.");
                            ...
                            if (!handled) {
                                log(out, "DnD.PrepForFsPanel.SupportingClasses.FileDrop: not a file list or reader - abort.");
                                evt.rejectDrop();
                            }
                        ...
                        log(out, "DnD.PrepForFsPanel.SupportingClasses.FileDrop: IOException - abort:");
                        io.printStackTrace(out);
                        evt.rejectDrop();
                    }   // end catch IOException
                    catch (java.awt.datatransfer.UnsupportedFlavorException ufe) {
                        log(out, "DnD.PrepForFsPanel.SupportingClasses.FileDrop: UnsupportedFlavorException - abort:");
                        ...
                        if (c instanceof javax.swing.JComponent) {
                            ...
                            log(out, "DnD.PrepForFsPanel.SupportingClasses.FileDrop: normal border restored.");
                        }   // end if: JComponent
                    }   // end finally
                }   // end drop

                public void dragExit(java.awt.dnd.DropTargetEvent evt) {
                    log(out, "DnD.PrepForFsPanel.SupportingClasses.FileDrop: dragExit event.");
                    // If it's a Swing component, reset its border
                    if (c instanceof javax.swing.JComponent) {
                        javax.swing.JComponent jc = (javax.swing.JComponent) c;
                        jc.setBorder(normalBorder);
                ...
                public void dropActionChanged(java.awt.dnd.DropTargetDragEvent evt) {
                    log(out, "DnD.PrepForFsPanel.SupportingClasses.FileDrop: dropActionChanged event.");
                    // Is this an acceptable drag event?
            ...
            log(out, "DnD.PrepForFsPanel.SupportingClasses.FileDrop: Drag and drop is not supported with this JVM");
    ...
    private static File[] createFileArray(BufferedReader bReader, PrintStream out) {
        try {
            ...
            log(out, "DnD.PrepForFsPanel.SupportingClasses.FileDrop: IOException");
        }
        return new File[0];
    }
    // END 2007-09-12 Nathan Blomquist -- Linux (KDE/Gnome) support added.
    ...
    private void makeDropTarget(final PrintStream out, final java.awt.Component c, boolean recursive) {
        ...
        try {
            ...
            e.printStackTrace();
            log(out, "DnD.PrepForFsPanel.SupportingClasses.FileDrop: Drop will not work due to previous error. Do you have another listener attached?");
        }   // end catch

        // Listen for hierarchy changes and remove the drop target when the parent gets cleared out.
        c.addHierarchyListener(new java.awt.event.HierarchyListener() {
            public void hierarchyChanged(java.awt.event.HierarchyEvent evt) {
                log(out, "DnD.PrepForFsPanel.SupportingClasses.FileDrop: Hierarchy changed.");
                java.awt.Component parent = c.getParent();
                if (parent == null) {
                    c.setDropTarget(null);
                    log(out, "DnD.PrepForFsPanel.SupportingClasses.FileDrop: Drop target cleared from component.");
                }   // end if: null parent
                else {
                    new java.awt.dnd.DropTarget(c, dropListener);
                    log(out, "DnD.PrepForFsPanel.SupportingClasses.FileDrop: Drop target added to component.");
    ...
    private boolean isDragOk(final PrintStream out, final java.awt.dnd.DropTargetDragEvent evt) {
        ...
        if (out != null) {
            if (flavors.length == 0)
                log(out, "DnD.PrepForFsPanel.SupportingClasses.FileDrop: no data flavors.");
    ...
    public static boolean remove(PrintStream out, java.awt.Component c, boolean recursive) {   // Make sure we support dnd.
        if (supportsDnD()) {
            log(out, "DnD.PrepForFsPanel.SupportingClasses.FileDrop: Removing drag-and-drop hooks.");
            c.setDropTarget(null);
            if (recursive && (c instanceof java.awt.Container)) {
...
/* ********  I N N E R   I N T E R F A C E   L I S T E N E R  ******** */
     ...
     * <code><pre>
     *      public class MyClass implements DnD.PrepForFsPanel.SupportingClasses.FileDrop.Listener
     *      ...
     *      public void filesDropped( java.io.File[] files )
     *      {
     *          ...
...
}   // end class DnD.PrepForFsPanel.SupportingClasses.FileDrop
